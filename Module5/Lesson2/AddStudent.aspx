<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddStudent.aspx.cs" Inherits="Lesson3.AddStudent" %>
...
<body>
    ...
    <div id="CenterDiv2">
        ...
        <p>
            <asp:ImageButton ID="btnInsert" runat="server" ImageUrl="~/images/Save.png" OnClick="btnInsert_Click" />
